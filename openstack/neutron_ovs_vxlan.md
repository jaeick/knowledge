...
```
[root@controller ~(keystone)]# openstack network create net-provider1 \
--provider-network-type flat \
--provider-physical-network physnet1 \
--share --external

[root@controller ~(keystone)]# openstack subnet create subnet-provider1-v4 \
...
[root@controller ~(keystone)]#  openstack subnet create subnet-selfservice1 \
--project admin \
